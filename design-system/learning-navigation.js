(function initializeLearningNavigation(global) {
  ...
  const LEARNING_CATALOG = [
    ...
    },
    {
      ...
      order: 6,
      items: [
        { id: 'knowledge-rag-course', title: '知识 / RAG 课程目录', path: 'docs/knowledge-rag/index.html', type: 'course', order: 1, status: 'available' },
        { id: 'knowledge-rag-boundary-pipeline', title: '01 边界与端到端流水线', path: 'docs/knowledge-rag/01-boundary-and-pipeline.html', type: 'theory', order: 2, status: 'available' },
        { id: 'knowledge-rag-ingestion-indexing', title: '02 摄取、切分与索引', path: 'docs/knowledge-rag/02-ingestion-chunking-and-indexing.html', type: 'theory', order: 3, status: 'available' },
        { id: 'knowledge-rag-retrieval-reranking', title: '03 检索与重排', path: 'docs/knowledge-rag/03-retrieval-and-reranking.html', type: 'theory', order: 4, status: 'available' },
        { id: 'knowledge-rag-grounding-security', title: '04 Grounding、引用与访问控制', path: 'docs/knowledge-rag/04-grounding-citations-and-access-control.html', type: 'theory', order: 5, status: 'available' },
        { id: 'knowledge-rag-evaluation-diagnosis', title: '05 评测与失败诊断', path: 'docs/knowledge-rag/05-evaluation-and-failure-diagnosis.html', type: 'theory', order: 6, status: 'available' },
        { id: 'knowledge-rag-checkpoint', title: '知识 / RAG 理论检查点', path: 'assessment/04-knowledge-rag-theory-checkpoint.html', type: 'checkpoint', order: 7, status: 'available' },
      ],
    },
    {
      id: 'l2-memory-system',
      ...
      order: 7,
      items: [
        { id: 'memory-system-course', title: '记忆系统课程目录', path: 'docs/memory/index.html', type: 'course', order: 1, status: 'available' },
        { id: 'memory-boundaries', title: '01 状态、会话与记忆边界', path: 'docs/memory/01-state-session-and-memory-boundaries.html', type: 'theory', order: 2, status: 'available' },
        { id: 'memory-types', title: '02 工作、情景、语义与程序记忆', path: 'docs/memory/02-memory-types.html', type: 'theory', order: 3, status: 'available' },
        { id: 'memory-lifecycle', title: '03 读取、写入、整合与遗忘', path: 'docs/memory/03-read-write-consolidation-and-forgetting.html', type: 'theory', order: 4, status: 'available' },
        { id: 'memory-governance', title: '04 隐私、投毒与治理', path: 'docs/memory/04-privacy-poisoning-and-governance.html', type: 'theory', order: 5, status: 'available' },
        { id: 'memory-system-checkpoint', title: '记忆系统理论检查点', path: 'assessment/05-memory-system-theory-checkpoint.html', type: 'checkpoint', order: 6, status: 'available' },
      ],
    },
    {
      ...
      order: 8,
      items: [
        { id: 'governance-observability-course', title: '治理与可观测课程目录', path: 'docs/governance-observability/index.html', type: 'course', order: 1, status: 'available' },
        { id: 'governance-online-control-plane', title: '01 在线横切职责与控制面', path: 'docs/governance-observability/01-online-cross-cutting-and-control-plane.html', type: 'theory', order: 2, status: 'available' },
        { id: 'governance-telemetry', title: '02 Trace、Log 与 Metric', path: 'docs/governance-observability/02-trace-log-and-metric.html', type: 'theory', order: 3, status: 'available' },
        { id: 'governance-identity-authorization-audit', title: '03 身份、权限与审计', path: 'docs/governance-observability/03-identity-authorization-and-audit.html', type: 'theory', order: 4, status: 'available' },
        { id: 'governance-injection-pii', title: '04 Prompt Injection、PII 与防护', path: 'docs/governance-observability/04-prompt-injection-pii-and-guardrails.html', type: 'theory', order: 5, status: 'available' },
        { id: 'governance-hitl-budget-incident', title: '05 HITL、预算与事件响应', path: 'docs/governance-observability/05-hitl-budget-and-incident-response.html', type: 'theory', order: 6, status: 'available' },
        { id: 'governance-observability-checkpoint', title: '治理与可观测理论检查点', path: 'assessment/06-governance-observability-theory-checkpoint.html', type: 'checkpoint', order: 7, status: 'available' },
      ],
    },
    {
      id: 'l2-evaluation',
      ...
      order: 9,
      items: [
        { id: 'evaluation-course', title: '评测层课程目录', path: 'docs/evaluation/index.html', type: 'course', order: 1, status: 'available' },
        { id: 'evaluation-objectives-datasets-baselines', title: '01 目标、数据集与基线', path: 'docs/evaluation/01-objectives-datasets-and-baselines.html', type: 'theory', order: 2, status: 'available' },
        { id: 'evaluation-outcome-trajectory', title: '02 结果评测与轨迹评测', path: 'docs/evaluation/02-outcome-and-trajectory-evaluation.html', type: 'theory', order: 3, status: 'available' },
        { id: 'evaluation-rules-humans-judge', title: '03 规则、人工与 LLM-as-a-Judge', path: 'docs/evaluation/03-rules-humans-and-llm-as-a-judge.html', type: 'theory', order: 4, status: 'available' },
        { id: 'evaluation-regression-release-gates', title: '04 回归测试与上线门禁', path: 'docs/evaluation/04-regression-tests-and-release-gates.html', type: 'theory', order: 5, status: 'available' },
        { id: 'evaluation-safety-feedback', title: '05 安全红队与线上反馈', path: 'docs/evaluation/05-safety-red-teaming-and-online-feedback.html', type: 'theory', order: 6, status: 'available' },
        { id: 'evaluation-checkpoint', title: '评测层理论检查点', path: 'assessment/07-evaluation-theory-checkpoint.html', type: 'checkpoint', order: 7, status: 'available' },
      ],
    },
    {
