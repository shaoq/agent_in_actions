(function initializeLearningNavigation(global) {
  ...
  const LEARNING_CATALOG = [
    ...
    },
    {
      ...
      order: 9,
      items: [
        { id: 'evaluation-system', title: '评测层', path: null, type: 'theory', order: 1, status: 'planned' },
        { id: 'model-gateway-infra', title: '模型网关与基础设施', path: null, type: 'theory', order: 2, status: 'planned' },
        { id: 'interaction-access', title: '交互与接入层', path: null, type: 'theory', order: 3, status: 'planned' },
      ],
    },
    {
      id: 'l3-engineering',
