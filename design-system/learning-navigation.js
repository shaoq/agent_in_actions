(function initializeLearningNavigation(global) {
  ...
  const LEARNING_CATALOG = [
    ...
    },
    {
      ...
      order: 5,
      items: [
        { id: 'tool-actions', title: '工具 / 动作层', path: null, type: 'theory', order: 1, status: 'planned' },
        { id: 'knowledge-rag', title: '知识 / RAG', path: null, type: 'theory', order: 2, status: 'planned' },
        { id: 'memory-system', title: '记忆系统', path: null, type: 'theory', order: 3, status: 'planned' },
        { id: 'governance-observability', title: '治理与可观测', path: null, type: 'theory', order: 4, status: 'planned' },
        { id: 'evaluation-system', title: '评测层', path: null, type: 'theory', order: 5, status: 'planned' },
        { id: 'model-gateway-infra', title: '模型网关与基础设施', path: null, type: 'theory', order: 6, status: 'planned' },
        { id: 'interaction-access', title: '交互与接入层', path: null, type: 'theory', order: 7, status: 'planned' },
      ],
    },
    {
      id: 'l3-engineering',
